...
const cvData = {
  ...
  skills: [
    ...
    { category: "Móvil & Otros", techs: ["Flutter (Profesional)", "Dart", "Java/Kotlin (Bases)", "Python (Bases)"], color: "#ec4899" },
  ...
  return (
    <div className="dashboard-container">
      ...
      <main className="dashboard-grid">
        ...
        {/* Resumen Profesional */}
        <section className="dashboard-card terminal-card">
